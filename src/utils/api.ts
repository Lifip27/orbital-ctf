...
export async function fetchSiteConfig(): Promise<SiteConfig[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch site configuration');
  }
...
export async function fetchRules(): Promise<RulesResponse> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch rules');
  }
  return response.json();
}
...
export async function fetchChallenge(challengeId: string): Promise<Challenge> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch challenge');
  }
  return response.json();
}
...
export async function fetchChallengesByCategory(categoryId: string): Promise<CategoryResponse> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch category challenges');
  }
  return response.json();
}
...
export async function fetchTeam(teamId: string): Promise<Team> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch team data');
  }
  return response.json();
}
...
export async function fetchLeaderboard(): Promise<LeaderboardResponse> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch leaderboard');
  }
  return response.json();
}
...
export async function fetchAnnouncements(): Promise<Announcement[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch announcements');
  }
  return response.json();
}
...
export async function fetchActivity(): Promise<ActivityLog[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch activity logs');
  }
  return response.json();
}
...
export async function fetchGameConfig(): Promise<GameConfig> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch game configuration');
  }
  return response.json();
}
...
export async function fetchScoreboardTeams(): Promise<ScoreboardTeam[]> {
  const response = await fetch('/api/leaderboard');
  if (!response.ok) {
    throw createApiError('Failed to fetch scoreboard teams');
  }
...
export async function fetchTeamPointHistory(teamId: string, limit: number = 1000): Promise<PointHistoryResponse> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch team point history');
  }
  return response.json();
}
...
export async function fetchHints(challengeId: string): Promise<Hint[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch hints');
  }
  return response.json();
}
...
export async function purchaseHint(hintId: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to purchase hint');
  }
}
...
export async function submitFlag(challengeId: string, flag: string): Promise<SubmissionResponse> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to submit flag');
  }
  return response.json();
}
...
export async function createAnnouncement(announcement: NewAnnouncement): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to create announcement');
  }
}
...
export async function deleteAnnouncement(id: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to delete announcement');
  }
}
...
export async function createChallenge(challenge: NewChallenge): Promise<Challenge> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to create challenge');
  }
...
export async function updateChallenge(challenge: Challenge): Promise<Challenge> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to update challenge');
  }
...
export async function uploadFile(file: File, challengeId: string): Promise<ChallengeFile> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to upload file');
  }
...
export async function deleteFile(filePath: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to delete file');
  }
}
...
export async function fetchAdminChallenges(): Promise<Challenge[]> {
  const response = await fetch('/api/admin/challenges');
  if (!response.ok) {
    throw createApiError('Failed to fetch challenges');
  }
  return response.json();
}
...
export async function deleteChallenge(id: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to delete challenge');
  }
}
...
export async function exportChallenges(): Promise<Challenge[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to export challenges');
  }
  return response.json();
}
...
export async function importChallenges(challenges: Challenge[]): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to import challenges');
  }
}
...
export async function updateSiteConfig(config: SiteConfig): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to update site configuration');
  }
}
...
export async function updateGameConfig(config: GameConfig): Promise<GameConfig> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to update game configuration');
  }
...
export async function fetchSiteConfigurations(): Promise<SiteConfiguration[]> {
  const response = await fetch('/api/config');
  if (!response.ok) {
    throw createApiError('Failed to fetch site configurations');
  }
  return response.json();
}
...
export async function updateSiteConfiguration(key: string, value: string): Promise<SiteConfiguration> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || `Failed to update configuration: ${key}`);
  }
  return response.json();
}
...
export async function fetchAdminTeams(): Promise<Team[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch teams');
  }
  return response.json();
}
...
export async function deleteTeam(id: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json(); 
    throw createApiError(data.error || 'Failed to delete team');
  }
}
...
export async function updateTeam(teamData: Partial<Team>): Promise<Team> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to update team');
  }
...
export async function fetchAdminUsers(): Promise<User[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch users');
  }
  return response.json();
}
...
export async function deleteAdminUser(id: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to delete user');
  }
}
...
export async function updateAdminUser(userData: Partial<User>): Promise<User> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to update user');
  }
...
export async function fetchAdminSubmissions(): Promise<AdminSubmission[]> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch submissions');
  }
  return response.json();
}
...
export async function deleteAdminSubmission(submissionId: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to delete submission');
  }
}
...
export async function deleteAdminSolve(challengeId: string, teamId: string): Promise<void> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to delete solve');
  }
}
...
export async function updateAdminActivityLog(
  ...
  if (!response.ok) {
    ...
    throw createApiError(res.error || 'Failed to update activity log');
  }
...
export async function deleteAdminActivityLog(id: string): Promise<void> {
  ...
  if (!response.ok) {
    const res = await response.json();
    throw createApiError(res.error || 'Failed to delete activity log');
  }
}
...
export async function fetchAdminMetrics(): Promise<AdminMetrics> {
  ...
  if (!response.ok) {
    throw createApiError('Failed to fetch metrics');
  }
  return response.json();
}
...
export async function signUp(data: SignUpRequest): Promise<SignUpResponse> {
  ...
  if (!response.ok) {
    const data = await response.json();
    throw createApiError(data.error || 'Failed to register');
  }
